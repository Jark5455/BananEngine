...
namespace Banan {
    ...
    void BananSwapChain::createRenderPass() {
        ...
        // null images to color attachment output
        ...
        dependencies[1].srcAccessMask = VK_ACCESS_SHADER_READ_BIT  | VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_READ_BIT;
        ...
        // color attachment to shader read only
        ...
        // depth attachment to shader read only and depth attachment
        ...
        // color attachment output to present src
    ...
    void BananSwapChain::createGBufferResources() {
        ...
        device.transitionImageLayout(gBufferAttachments[1]->getImageHandle(), VK_FORMAT_R16G16B16A16_SFLOAT, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, 1, 1);
        device.transitionImageLayout(gBufferAttachments[2]->getImageHandle(), VK_FORMAT_R8G8B8A8_UNORM, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, 1, 1);
    }
