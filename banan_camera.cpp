...
namespace Banan {
    ...
    const glm::mat4 &BananCamera::getInverseView() const {
        return inverseViewMatrix;
    }

    void BananCamera::setViewDirection(glm::vec3 position, glm::vec3 direction, glm::vec3 up) {
    ...
    void BananCamera::setViewTarget(glm::vec3 position, glm::vec3 target, glm::vec3 up) {
        setViewDirection(position, target - position, up);
    }

    void BananCamera::setViewYXZ(glm::vec3 position, glm::vec3 rotation) {
