...
// class member functions
    ...
    void BananDevice::createImage(uint32_t width, uint32_t height, VkImageUsageFlags usage, VkMemoryPropertyFlags propertiesflags, VkImage &image, VkDeviceMemory &bufferMemory) {
        ...
        vkBindImageMemory(device_, image, bufferMemory, 0);
    }
    ...
    void BananDevice::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout) {
        VkCommandBuffer commandBuffer = beginSingleTimeCommands();
